...
func (im IBCModule) OnRecvPacket(
	...
	case *types.LeaderboardPacketData_CandidatePacket:
		packetAck, err := im.keeper.OnRecvCandidatePacket(ctx, modulePacket, *packet.CandidatePacket)
		if err != nil {
...
func (im IBCModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.LeaderboardPacketData_CandidatePacket:
		err := im.keeper.OnAcknowledgementCandidatePacket(ctx, modulePacket, *packet.CandidatePacket, ack)
		if err != nil {
			return err
		}
...
func (im IBCModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.LeaderboardPacketData_CandidatePacket:
		err := im.keeper.OnTimeoutCandidatePacket(ctx, modulePacket, *packet.CandidatePacket)
		if err != nil {
			return err
		}
