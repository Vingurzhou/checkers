/**
 * Created by zhouwenzhe on 2023/5/30
 */
...
func setup(withGenesis bool, invCheckPeriod uint) (*App, GenesisState) {
	...
	app := New(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, invCheckPeriod, appparams.EncodingConfig(encCdc), EmptyAppOptions{})
	if withGenesis {
